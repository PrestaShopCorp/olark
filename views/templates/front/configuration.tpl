<link href="{$module_dir}css/olark.css" rel="stylesheet" type="text/css">
...
<div class="olark-wrap">
	<p class="olark-intro"><a href="https://www.olark.com/prestashop?rid=prestashop&utm_source=prestashop&utm_medium=partner&utm_campaign=cart" class="olark-logo" target="_blank"><img src="{$module_dir}img/olark_logo.png" alt="Olark" border="0" /></a><span>{l s='Chat with your Customers' mod='olark'}</span><br />
	...
	<div class="olark-content">
		...
		<ul>
			<li><img src="{$module_dir}img/olark-chat.png" alt="" /> {l s='Chat using your IM client' mod='olark'}</li>
			<li class="alt"><img src="{$module_dir}img/olark-heart.png" alt="" /> {l s='Satisfying User Experience' mod='olark'}</li>
			<li><img src="{$module_dir}img/olark-team.png" alt="" /> {l s='Work together as a team' mod='olark'}</li>
			<li class="alt"><img src="{$module_dir}img/olark-stats.png" alt="" /> {l s='Detailed Reporting &amp; Stats' mod='olark'}</li>
			<li><img src="{$module_dir}img/olark-crm.png" alt="" /> {l s='CRM &amp; Helpdesk Integration' mod='olark'}</li>
			<li class="alt"><img src="{$module_dir}img/olark-code.png" alt="" /> {l s='Powerful API' mod='olark'}</li> 
		</ul>
	...
	<form action="{$form|escape:'htmlall':'UTF-8'}" method="post">
		<fieldset>
			<legend><img src="{$module_dir}img/icon-config.gif" alt="" />{l s='Configuration' mod='olark'}</legend>
		...
		<br />
		<fieldset>
			<legend><img src="{$module_dir}img/icon-config.gif" alt="" />{l s='Additional Configuration (optional)' mod='olark'}</legend>
